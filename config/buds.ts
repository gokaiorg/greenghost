...
export const buds: Bud[] = [
  ...
  },
  {
    ...
    relieves: 'Anxious, Dry mouth, Paranoid',
    grower: 'Green Ghost',
    growerSlug: '/',
    environment: 'Organic Indoor',
    grade: 'AA Grade',
    ...
    origin: 'Phuket',
    description:
      "Hawaiian is a vibrant sativa marijuana strain celebrated for its ability to inspire happy and creative thoughts. Originating from the tropical paradise it’s named after, this strain delivers a fragrant aroma reminiscent of sun-soaked tropical fruits, instantly transporting you to a serene beachside escape. Hawaiian’s uplifting effects make it an excellent choice for unwinding after a long day or for sparking creativity during moments of inspiration. Its light green buds are a visual delight, adding to the strain's tropical allure. \n\n Known for its therapeutic benefits, Hawaiian is often selected by medical marijuana patients to help alleviate symptoms associated with chronic pain, bipolar disorder, and muscle spasms. The strain’s balanced sativa profile ensures a calming yet mentally energizing experience, ideal for both medicinal and recreational purposes. Whether you’re lounging at the beach or enjoying a quiet evening, Hawaiian offers a perfect blend of relaxation and euphoria. \n\n Hawaiian’s tropical profile extends beyond its aroma, with a flavor that mirrors the sweet, fruity essence of its scent. Each inhale is a journey into lush island vibes, making it a favorite among cannabis enthusiasts seeking a flavorful and uplifting experience. From its exotic lineage to its therapeutic effects, Hawaiian is truly a strain that embodies the essence of paradise.",
    descSeo:
      'Hawaiian, a tropical sativa strain, offers fruity flavors, creative energy, and relief from pain, bipolar disorder, and muscle spasms. Perfect for relaxation.',
    images: [
      '/media/green-ghost-degen-weed-shop-strain-hawaiian-bud-01.webp',
  ...
  },
  {
    ...
    THC: '25',
    CBD: '0',
    effects: 'Uplift, Creativity, Calming',
    relieves: 'Fatigue, Pain, Depression',
    grower: 'Green Ghost',
    growerSlug: '/',
    environment: 'Organic Indoor',
    grade: 'AA Grade',
    ...
    origin: 'Phuket',
    description:
      'Pineapple Express, a vibrant sativa-dominant hybrid (60% sativa/40% indica), springs from the iconic cross of Trainwreck and Hawaiian, earning its fame long before its 2008 cinematic spotlight. This beloved strain, a staple in dispensaries nationwide, captivates with its lively, long-lasting effects that hit fast and keep you buzzing. With a potent 20-25% THC, it ignites an energetic, alert high that sparks creativity and sharpens focus, making it perfect for morning, afternoon, or early evening sessions. \n\n The flavor is a tropical explosion—bright citrus and juicy pineapple mingle with earthy pine, driven by terpenes like caryophyllene, limonene, and ocimene. Its aroma is equally bold, with funky citrus overtones that entice the senses. Visually, Pineapple Express impresses with well-formed, Styrofoam-like nuggets, dense and resinous, promising quality in every puff. \n\n Medical users turn to this strain for relief from depression, fatigue, anxiety, stress, and mild pain, thanks to its uplifting yet calming vibe. The high enhances sensory awareness while delivering a gentle body-numbing buzz, ideal for those seeking both stimulation and relaxation. Whether you’re chasing inspiration or a mood boost, Pineapple Express delivers a dynamic, flavorful experience that’s as functional as it is delightful, cementing its status as a cannabis classic.',
    descSeo:
  ...
  },
  {
    ...
    relieves: 'Dry mouth, Dizzy, Dry eyes',
    grower: 'Green Ghost',
    growerSlug: '/',
    environment: 'Organic Greenhouse',
    grade: 'AAA Grade',
    ...
    origin: 'Phuket',
    description:
      'Cherry Z is a well-balanced hybrid strain born from a genetic cross between the iconic Original Z and Cherry Pie, offering a rich blend of flavor and effects. With a THC content of around 19%, this strain is ideal for seasoned cannabis enthusiasts looking for a flavorful yet potent experience. Cherry Z stands out for its delightful aroma of tree fruits and a flavor profile that harmoniously combines sweet apple and tangy grapefruit, making it a treat for the senses. \n\n The strain delivers a unique high that enhances focus, encourages laughter, and promotes relaxation. These effects make Cherry Z a versatile choice, perfect for creative endeavors, social gatherings, or simply unwinding after a long day. Its dominant terpene, myrcene, contributes to its calming properties and fruity flavor, ensuring an enjoyable experience with every use. \n\n Cherry Z is also a popular choice among medical marijuana patients seeking relief from anxiety, depression, and headaches. The uplifting yet soothing effects provide a natural way to combat stress and improve mood. Bred by Paradiso, Cherry Z combines its fruity appeal with therapeutic potential, making it a sought-after strain for recreational and medicinal users alike.',
    descSeo:
      'Cherry Z, a hybrid of Original Z and Cherry Pie, offers apple-grapefruit flavors and relaxing, giggly effects perfect for anxiety, depression, and stress.',
    images: [
      '/media/green-ghost-degen-weed-shop-strain-cherry-z-bud-01.webp',
  ...
  },
  {
    ...
    relieves: 'Chronic Pain, Depression, Fatigue',
    grower: 'Green Ghost',
    growerSlug: '/',
    environment: 'Organic Greenhouse',
    grade: 'AAA Grade',
    ...
    origin: 'Phuket',
    description:
      "Pink Zkittlez is an evenly balanced hybrid (50% indica / 50% sativa) that delivers both mental clarity and full-body relaxation. Created by crossing Tropical Cherry and Zkittlez Bomb, this stunning strain boasts a vibrant pink appearance, with long, tapered forest green nugs featuring bright pink undertones, pinkish-orange hairs, and a frosty layer of light pink-tinted trichomes. \n\n Breaking apart its resinous buds unleashes a burst of tropical sweetness, blending zesty candy, pink fruits, and a hint of spicy gas. The flavor profile is even more captivating, combining sour pineapple candy, fresh strawberries, and ripe cherries for a mouthwatering experience. \n\n The high-THC content (27-31%) ensures an immediate euphoric uplift, enhancing focus, creativity, and motivation for mentally engaging tasks. As the cerebral buzz settles, a deep physical relaxation takes over, leaving you calm yet mentally alert. Despite its soothing effects, Pink Zkittlez won't drain your energy, making it ideal for daytime or evening use. With its potent effects and rich terpene profile, Pink Zkittlez is a top choice for managing chronic fatigue, pain, depression, headaches, nausea, and ADD/ADHD. Whether you're looking for a flavor-packed smoke or a balanced high, this strain delivers a sensory experience as stunning as its pink-hued buds.",
    descSeo:
  ...
  },
  {
    ...
    descSeo:
      'Orange Sherbert, a hybrid from Barney’s Farm, blends Orange Cream, Purple Urkle, and Cherry Pie for a sweet citrus flavor and relaxing euphoric effects.',
    images: [
      '/media/green-ghost-degen-weed-shop-strain-orange-sherbert-bud-01.webp',
  ...
  },
  {
    ...
    origin: 'Phuket',
    description:
      'Cereal Milk, a standout hybrid from the renowned Cookies family, emerges from a masterful cross of Y Life (a blend of Cookies and Cherry Pie) with Snowman, a sativa-leaning Cookies phenotype. This strain is a sensory delight, boasting a bold, nostalgic flavor profile that evokes the creamy sweetness of milk left behind in a bowl of sugary cereal, laced with subtle notes of ripe berries and a whisper of fruity zest. \n\n Its aroma mirrors this indulgent experience, adding a faint herbal nuance that rounds out its charm. Visually, Cereal Milk dazzles with dense, resin-soaked buds—tapered, heart-shaped, and olive-green with minty hints—adorned by fiery orange hairs and a thick blanket of frosty trichomes that signal its potency. As a perfectly balanced hybrid (50% indica/50% sativa), it delivers a high that’s both uplifting and grounding. \n\n The journey begins with a euphoric rush, igniting pure joy and mental clarity, followed by a wave of creative energy and sociability that keeps you engaged yet relaxed for hours. With a THC range of 18-25%, Cereal Milk is a go-to for easing chronic stress, depression, nausea, appetite loss, fatigue, and even persistent pain. Ideal for a laid-back weekend, this strain’s long-lasting effects and delectable taste make it a rare gem for cannabis connoisseurs seeking bliss in every puff.',
    descSeo:
  ...
  },
  {
    ...
    origin: 'Phuket',
    description:
      'Master OG, also known as "Master OG Kush," is a premium indica-dominant hybrid cannabis strain crafted by Cabin Fever Seed Breeders. Created through the expert crossbreeding of Master Kush and Empress Kush, this strain offers a uniquely relaxing experience, perfect for unwinding after a long day. Renowned for its large, dense buds, Master OG stands out with its vibrant green hues and heavy branches, often bending under the weight of its resinous flowers. \n\n The strain’s signature pine aroma is complemented by earthy undertones, delivering a smooth and calming flavor profile that’s as therapeutic as it is enjoyable. With a rich terpene profile and potent effects, Master OG is a popular choice among cannabis enthusiasts seeking relief from chronic pain, nausea, and insomnia. Its soothing indica dominance promotes deep relaxation, making it an excellent strain for nighttime use or moments when tranquility is paramount. \n\n Medical marijuana patients appreciate Master OG for its ability to ease physical discomfort and promote restful sleep while alleviating stress and tension. Recreational users value the strain for its euphoric onset and full-body relaxation, creating a balanced high that’s both uplifting and calming. Whether you’re seeking medicinal relief or a serene escape, Master OG delivers a deeply satisfying cannabis experience.',
    descSeo:
      'Master OG, an indica hybrid, offers pine aromas, relaxing effects, and relief from pain, nausea, and insomnia. Perfect for tranquility and restful sleep.',
    images: [
      '/media/green-ghost-degen-weed-shop-strain-master-og-bud-01.webp',
  ...
  },
  {
    ...
    origin: 'Phuket',
    description:
      'OG Kush, also known as "Premium OG Kush," is one of the most iconic cannabis strains in history. First cultivated in Florida in the early ‘90s, this legendary hybrid was created by crossing Chemdawg, Lemon Thai, and a Hindu Kush plant from Amsterdam. The result is a strain with a distinct terpene profile, delivering a complex aroma of fuel, skunk, and spice, with undertones of lemon-pine freshness. \n\n With its high THC content, OG Kush produces a powerful mix of cerebral euphoria and full-body relaxation, making it perfect for unwinding after a long day. Many users report relief from stress, anxiety, and pain, while its uplifting effects can boost creativity and social vibes. The strain’s “OG” designation is often debated—some claim it stands for “Original Gangster,” while others say it means “Ocean Grown”, referring to its coastal cultivation roots. \n\n OG Kush became a West Coast cannabis powerhouse when Matt “Bubba” Berger brought it from Florida to Los Angeles in 1996, where it was later refined by Josh D. Since then, it has served as the genetic foundation for countless legendary strains, including GSC, Headband, Tahoe OG, SFV OG, and Ghost OG. Whether you’re a longtime fan or a new enthusiast, OG Kush remains a must-try strain that continues to set the gold standard in cannabis.',
    descSeo:
  ...
  },
  {
    ...
    THC: '21',
    CBD: '0',
    effects: 'Energizing buzz, Enhanced creativity, Social ease',
    relieves: 'FatigueLack of focus, Social anxiety',
    grower: 'Green Ghost',
    growerSlug: '',
    environment: 'Indoor',
    grade: 'AAAA Grade',
  ...
  },
  {
    ...
    THC: '21',
    CBD: '0',
    effects: 'Calming, Giggly, Happy',
    relieves: 'Headaches, Stress, Depression',
    grower: 'Green Ghost',
    growerSlug: '',
    environment: 'Indoor',
    grade: 'AAAA Grade',
    ...
    images: [
      '/media/green-ghost-degen-weed-shop-strain-tropical-sunrise-cover.webp',
      '/media/green-ghost-degen-weed-shop-strain-tropical-sunrise-cover.webp',
      '/media/green-ghost-degen-weed-shop-strain-tropical-sunrise-cover.webp',
    ],
  ...
  },
  {
    ...
    THC: '1',
    CBD: '15',
    effects: 'Calming, Uplifted, Tingly',
    relieves: 'Stress, Inflammation, Muscle tension',
    grower: 'CBD Cannabiz farm',
    growerSlug: '/cbd-cannabiz-farm',
    environment: 'Indoor',
    grade: 'AAAA Grade',
    ...
    origin: 'Phuket',
    description:
      "CBD Charlotte's Angel is a sativa-dominant hybrid (70% sativa/30% indica) from Dutch Charlotte and Red Angel, boasting an average 15% CBD content with THC below 1%, perfect for a non-intoxicating experience. Its herbal aroma features pine, diesel, and earthy notes, while the flavor offers woody spice with citrus hints. The neon-green buds, with orange hairs and purple undertones coated in white trichomes, reflect premium quality. \n\n This CBD-rich strain provides a gentle, uplifting high, promoting a mellow relaxation that calms the body and mind. With phenotypes reaching 20-25% CBD, it stands out for its pungent terpene profile—herbal with diesel, citrus, and pine—delivering a tasty, relaxing vibe without strong psychoactive effects. \n\n As a 3-time cup winner, CBD Charlotte's Angel is ideal for those seeking a high-CBD option with a unique, calming presence. Its tall growth and large buds make it a standout for enthusiasts wanting purity and authenticity in a soothing, focused journey.",
    descSeo:
      "CBD Charlotte's Angel, sativa hybrid with 15% CBD and THC <1%. Herbal pine flavors for calming, uplifting relaxation in the cannabis scene.",
    images: [
