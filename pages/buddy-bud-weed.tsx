...
const GrowerCosmic: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Green Ghost - Grower - Buddy Bud Weed.</title>
        <meta
          name={'description'}
          content={
        ...
        <meta
          property={'og:title'}
          content={'Green Ghost - Grower - Buddy Bud Weed.'}
        />
        <meta
        ...
        <meta property={'og:url'} content={'https://green.gd/buddy-bud-weed'} />
        <meta
          name={'twitter:title'}
          content={'Green Ghost - Grower - Buddy Bud Weed.'}
        />
        ...
        <meta
          name={'twitter:url'}
          content={'https://green.gd/buddy-bud-weed'}
        />
      </Head>
      <MainLayout>
        <HeaderMenu>
        ...
        <Box display={'flex'} flexDirection={'column'} fontFamily={'vt323'}>
          ...
          >
            ...
            <Text
              ...
              mr={'auto'}
            >
              The Buddy Bud takes pride in growing and harvesting only the
              finest cannabis plants. Plants are carefully tended with love and
              attention, ensuring that every bud is the highest quality.
            </Text>
          </Box>
        </Box>
        <Box display={'flex'} flexDirection={'column'} fontFamily={'vt323'}>
          <Box display={'flex'} alignItems={'center'} gap={3}>
            <Link
              href={'https://buddybudweed.com/'}
              title={'Buddy Bud Weed Website'}
              passHref
            >
              <Box
                display={'flex'}
            ...
            <Box bgColor={'black'} borderRadius={'100%'} mx={'2'}>
              <SocialIcon
                url={'https://www.instagram.com/buddybudweed/'}
                bgColor={'#4cfd27'}
            ...
            <Box bgColor={'black'} borderRadius={'100%'} mx={'2'}>
              <SocialIcon
                url={'https://www.facebook.com/profile.php?id=100090227299714'}
                bgColor={'#4cfd27'}
                style={{ width: 36, height: 36 }}
              />
            </Box>
