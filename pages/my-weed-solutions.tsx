  ...
  return (
    <>
      <Head>
        ...
        <meta
          property={'og:url'}
          content={'https://green.gd/my-weed-solutions'}
        />
        <meta
          name={'twitter:title'}
          content={'Green Ghost - Grower - My Weed Solutions.'}
      ...
      <MainLayout>
        ...
        <Box display={'flex'} flexDirection={'column'} fontFamily={'vt323'}>
          <Box display={'flex'} alignItems={'center'} gap={3}>
            <Link
              href={'https://mwsphuket.wixsite.com/myweedsolutions'}
              title={'My Weed Solutions Website'}
              passHref
            >
              <Box
                display={'flex'}
        ...
        <Box display={'flex'} flexDirection={'column'} fontFamily={'vt323'}>
          ...
          <Box display={'flex'} alignItems={'center'} gap={3}>
            <Link
              href={'https://myweed.in/'}
              title={'My Weed Website'}
              passHref
            >
              <Box
                display={'flex'}
