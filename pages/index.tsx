    ...
    <MainLayout>
      ...
      >
        <Text as="h2" fontSize="4xl" marginBottom={4}>
          ...
          for high-quality marijuana, weed, and ganja.
        </Text>
        <Text as="p" fontSize="3xl">
          Our cannabis shop in Phuket offers a wide variety of locally-sourced
          and organic products, including flowers, edibles, and accessories. Our
          experienced staff is always on hand to help you find the perfect
          product and answer any questions. Visit us today and discover the best
          selection of cannabis products in Phuket.
        </Text>
      </Box>
      <Text
        display="inline-flex"
