    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-4">
        ...
        <ImageSlider
          images={[
            {
              src: `/images/edibles/green-ghost-degen-weed-shop-menu-edible-${product.id}-cover.avif`,
              alt: `${product.name} cover`
            },
            {
              src: `/images/edibles/green-ghost-degen-weed-shop-menu-edible-${product.id}-01.avif`,
              alt: `${product.name} 01`
            },
            {
              src: `/images/edibles/green-ghost-degen-weed-shop-menu-edible-${product.id}-02.avif`,
              alt: `${product.name} 02`
            }
          ]}
          width={200}
        ...
        <div className="md:hidden mb-4">
          {product.status === 'In stock' ? (
            <div className="flex flex-col items-center space-y-2">
              ...
              <button
                onClick={() => addItem(product, 'Edibles')}
