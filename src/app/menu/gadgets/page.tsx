    ...
    <div className="relative">
      <div className="container mx-auto px-4">
        ...
        <div className="flex  md:flex-row flex-col md:items-center space-x-2 mb-2">
          <h1 className="text-xl lg:text-2xl font-bold text-left whitespace-nowrap">Gadgets Menu</h1><p className="text-xs text-gray-400">Elevate your smoking experience.</p>
        </div>
