    ...
    <div className="relative">
      <div className="container mx-auto px-4">
        ...
        <div className="flex  md:flex-row flex-col md:items-center space-x-2 mb-2">
          <h1 className="text-xl lg:text-2xl font-bold text-left whitespace-nowrap">Concentrates Menu</h1><p className="text-xs text-gray-400">Concentrates price for 1 gram.</p>
        </div>
            ...
            <li key={concentrate.id} className="relative">
              ...
              {concentrate.status === 'In stock' && (
                <div className="mt-8 md:mt-0 md:absolute md:top-1 md:left-1 md:right-1 md:h-[232px] lg:h-[185px] xl:h-[193px] 2xl:h-[236px] pointer-events-none z-10">                  <div className="absolute bottom-1 right-1 pointer-events-auto">
                  <BagAddButton product={concentrate} category="Concentrates" compact />
                </div>
                </div>
              )}
            </li>
