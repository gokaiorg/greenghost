...
export function generateMetadata({
  ...
  keywords = ['cannabis', 'weed', 'marijuana', 'thai weed', 'bangkok', 'phuket', 'pattaya', 'delivery'],
  image,
  pathname = '/',
  type = 'website',
  publishedTime,
 ...
 */
export function generateProductMetadata(category?: string, defaultCategory = 'products') {
  ...
  const title = safeCategory && safeCategory.length > 0
