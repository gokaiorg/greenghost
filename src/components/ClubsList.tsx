  ...
  return (
    <section className="container mx-auto px-4 py-8">
      <h2 className="text-xl md:text-2xl font-bold mb-6">
        Join Our <span className="text-[#13DE00]">Cannabis Clubs</span>
      </h2>
      <ul
        className="grid md:grid-cols-2 lg:grid-cols-3 gap-6"
        aria-label="Cannabis Clubs List"
      >
        {clubs.map((club, index) => {
          ...
          return (
            <li
              key={index}
              className="bg-[#13DE00]/5 border border-[#13DE00]/21 overflow-hidden hover:border-[#13DE00]/50 transition-all group list-none"
            >
              {/* Image */}
