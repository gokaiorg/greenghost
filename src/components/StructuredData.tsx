    ...
    generateWebPageSchema(
      {
        ...
        description:
          "Explore our Thailand cannabis menu: buds, edibles, concentrates, CBD & THC. Buy weed online with Green Ghost.",
        url: menuUrl,
...
export async function generateLocationSchema(
  locationSlug: string,
  organization: Organization,
) {
    ...
    generateWebPageSchema(
      {
        ...
        description:
          ...
          `Visit our ${location.name} location for premium cannabis products.`,
        url: locationUrl,
