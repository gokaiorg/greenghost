...
import { LawData } from "@/lib/firestore";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-12">
      {items.map((item, index) => (
        <div
          key={index}
          className="bg-[#13DE00]/13 border border-[#13DE00]/30 p-6 shadow-lg hover:border-[#13DE00]/60 transition-colors"
        >
          ...
          <h3 className="text-xl font-bold text-[#13DE00] mb-4">
            {item.title}
          </h3>
