      ...
      <div className="bg-[#13DE00] p-6 md:p-8 relative">
        ...
        >
          ...
          <div>
            <label
              htmlFor="name"
              className="block text-black mb-2 font-bold font-pixel text-sm"
            >
              NAME{" "}
          ...
          <button
            ...
            className={`w-full border-2 border-black cursor-pointer py-4 px-6 font-bold font-pixel text-lg flex items-center justify-center gap-2 transition-all duration-300 ${
              status === "success"
          ...
          {status === "error" && (
            <p
              role="alert"
              aria-live="assertive"
              className="text-red-600 text-center font-mono font-bold"
            >
              ❌ {errorMessage}
            </p>
          )}
